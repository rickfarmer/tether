...
// --------------------------------
// For OSX/Linux use:
// $ cd /code/harvard/tether/jni
// $ gcc -o proxy proxy.c
// Then run using:
// $ ./proxy
// Uncomment the following "main" class
// and proxy_port arg and comment out the int proxy(int start) below
//
...
// For use as a library for iOS or Android
// uncomment the following "int proxy(int start)" below
// and proxy_port arg
//
// int proxy(int start) {
...
int proxy(int start) {
	...
	// Step 3: listen()
	// Listen on the specified port from incoming connections
